...
import '../../features/auth/state/login.form.bloc.dart' as _i28;
import '../../features/auth/state/signup.form.bloc.dart' as _i29;
import '../../features/dashboard/bloc/create.project.form.bloc.dart' as _i27;
import '../../features/dashboard/bloc/dasboard.bloc.dart' as _i8;
import '../../features/dashboard/bloc/project.bloc.dart' as _i21;
import '../../features/dashboard/bloc/tags.bloc.dart' as _i15;
import '../../features/feed/state/feed.bloc.dart' as _i26;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.DasboardBloc>(() => _i8.DasboardBloc());
    gh.lazySingleton<_i9.HiveStore>(() => _i9.HiveStore());
    gh.lazySingleton<_i10.Biite>(() => _i10.Biite(key: gh<_i11.Key>()));
    ...
    gh.lazySingleton<_i13.CompensationFieldBloc>(
      () => firebaseModule.compensationFieldBloc,
      instanceName: 'createProject',
    );
    gh.lazySingleton<_i14.DescriptionFieldBloc>(
    ...
    gh.lazySingleton<_i26.FeedBloc>(() => _i26.FeedBloc(
          gh<_i20.ProjectRepository>(),
          gh<_i24.BidRepository>(),
        ));
    gh.lazySingleton<_i27.CreateProjectFormBloc>(
        () => _i27.CreateProjectFormBloc(
              gh<_i13.CompensationFieldBloc>(instanceName: 'createProject'),
              gh<_i14.DescriptionFieldBloc>(instanceName: 'createProject'),
              gh<_i7.NameFieldBloc>(instanceName: 'createProject'),
              gh<_i21.ProjectBloc>(),
            ));
    gh.lazySingleton<_i28.LoginFormBloc>(() => _i28.LoginFormBloc(
          gh<_i12.EmailFieldBloc>(instanceName: 'login'),
          gh<_i6.PasswordFieldBloc>(instanceName: 'login'),
          gh<_i25.AuthBloc>(),
        ));
    gh.lazySingleton<_i29.SignupFormBloc>(() => _i29.SignupFormBloc(
          gh<_i12.EmailFieldBloc>(instanceName: 'signup'),
