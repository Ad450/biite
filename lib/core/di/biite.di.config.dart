...
import '../../features/dashboard/bloc/tags.bloc.dart' as _i3;
...
import '../presentation/state/email.field.bloc.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.TagsBloc>(() => _i3.TagsBloc());
    gh.lazySingleton<_i4.FirebaseAuth>(() => firebaseModule.firebaseAuth);
    gh.lazySingleton<_i5.FirebaseStorage>(() => firebaseModule.firebaseStorage);
    ...
    gh.singleton<_i10.EmailFieldBloc>(
    ...
    gh.singleton<_i8.NameFieldBloc>(
    ...
    gh.lazySingleton<_i18.DasboardBloc>(() => _i18.DasboardBloc(
          ...
          gh<_i8.NameFieldBloc>(instanceName: 'createProject'),
          gh<_i3.TagsBloc>(),
        ));
    ...
    gh.lazySingleton<_i22.LoginFormBloc>(() => _i22.LoginFormBloc(
          gh<_i10.EmailFieldBloc>(instanceName: 'login'),
    ...
    gh.lazySingleton<_i24.SignupFormBloc>(() => _i24.SignupFormBloc(
          gh<_i10.EmailFieldBloc>(instanceName: 'signup'),
