...
import 'package:biite/profile/widget/edit.profile.avatar.dart';
import 'package:biite/profile/widget/profile.button.dart';
import 'package:biite/profile/widget/profile.description.field.dart';
import 'package:biite/profile/widget/profile.name.field.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<SignupBloc, SignupState>(
      ...
      child: GestureDetector(
        onTap: () => showBiiteLogoutDialog(context, bloc.logout),
        child: Text(
          'LOGOUT',
          style: context.appTheme.textTheme.bodySmall?.copyWith(
            fontSize: 16,
