...
import '../../api/storage/hive.storage.dart' as _i12;
...
import '../../features/dashboard/bloc/dasboard.bloc.dart' as _i11;
import '../../features/feed/state/feed.bloc.dart' as _i25;
import '../presentation/state/compensation.field.bloc.dart' as _i7;
import '../presentation/state/confirm.password.bloc.dart' as _i17;
import '../presentation/state/description.field.bloc.dart' as _i6;
import '../presentation/state/email.field.bloc.dart' as _i3;
import '../presentation/state/name.field.bloc.dart' as _i5;
import '../presentation/state/password.field.bloc.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.EmailFieldBloc>(() => _i3.EmailFieldBloc());
    gh.factory<_i4.PasswordFieldBloc>(() => _i4.PasswordFieldBloc());
    gh.factory<_i5.NameFieldBloc>(() => _i5.NameFieldBloc());
    gh.factory<_i6.DescriptionFieldBloc>(() => _i6.DescriptionFieldBloc());
    gh.factory<_i7.CompensationFieldBloc>(() => _i7.CompensationFieldBloc());
    ...
    gh.lazySingleton<_i11.DasboardBloc>(() => _i11.DasboardBloc());
    gh.lazySingleton<_i12.HiveStore>(() => _i12.HiveStore());
    gh.lazySingleton<_i13.CreateProjectFormBloc>(
        () => _i13.CreateProjectFormBloc(
              gh<_i7.CompensationFieldBloc>(),
              gh<_i6.DescriptionFieldBloc>(),
            ));
    ...
    gh.lazySingleton<_i15.LoginFormBloc>(() => _i15.LoginFormBloc(
          gh<_i3.EmailFieldBloc>(),
          gh<_i4.PasswordFieldBloc>(),
        ));
    gh.lazySingleton<_i16.UserRepository>(() => _i16.UserRepositoryImpl());
    gh.factory<_i17.ConfirmPasswordFieldBloc>(
        () => _i17.ConfirmPasswordFieldBloc(gh<_i4.PasswordFieldBloc>()));
