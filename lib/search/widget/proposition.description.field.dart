...
class PropositionDescriptionField extends StatelessWidget {
  const PropositionDescriptionField({super.key});
  ...
  Widget build(BuildContext context) {
    final bloc = getIt.get<DescriptionFieldBloc>(instanceName: "bid");
