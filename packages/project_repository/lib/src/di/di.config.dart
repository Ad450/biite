...
import '../project_repository.dart' as _i258;
import 'di.dart' as _i913;

extension GetItInjectableX on _i174.GetIt {
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt initializeProjectDeps({
    String? environment,
    ...
    gh.lazySingleton<_i258.ProjectRepository>(() => _i258.ProjectRepostoryImpl(
          gh<_i974.FirebaseFirestore>(),
          gh<_i486.HiveStore>(),
          gh<_i730.CloudStorage>(),
        ));
    return this;
  }
}
